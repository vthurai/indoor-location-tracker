...
public class ApplicationConfig {
	...
	public LocationTrackingPipelineOptions getOptions() {
		
		LocationTrackingPipelineOptions options = PipelineOptionsFactory.as(LocationTrackingPipelineOptions.class);
		...
		options.setJobName("Real-Time-Location-Tracker_" + System.currentTimeMillis());
